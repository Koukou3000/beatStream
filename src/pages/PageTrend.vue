    ...
    <div class="rank__container" >    
        ...
        <transition name="curtain">            
            <div class="rank__curtain" v-show="showCurtain">
                ...
                <span>TOP 3</span>
                <!-- 选择 - 结果 -->
                <div class="rank__result" @click="go('podium')" title="直接查看结果">
                ...
                <!-- 选择 - 试听 -->
                <div class="rank__play" @click="go('crossfade')" title="试听内容">
                ...
                <transition name="startload" appear>
        ...
        <div class="speaker__icon" v-show="carousel=='on'">
        ...
        <div class="podium__" v-if="carousel=='podium'">
            <img src="https://picx.zhimg.com/80/v2-83b1af728236e726fd2e4004da58661e_720w.webp?source=1940ef5c" alt=""/>
        </div>
        ...
        go(e){      
            ...
            if(e == 'podium'){
                ...
                let onload = 0
                    ...
                    //     onload ++
                        console.log('当前已经完成 ',onload,'/',total) // 更新状态
                    //     // 把图片放在refs引用的位置，在合适的时候切换
                    // };
                    // image.onerror = function(){
                    //     console.log('下载失败')
                    // };
                    // image.src = 'https://picx.zhimg.com/80/v2-83b1af728236e726fd2e4004da58661e_720w.webp?source=1940ef5c';
                ...
                this.timer = setInterval(() => {
                    onload++
                    this.loadPercent = 100*onload / total
                    this.loadingHint = '正在载入图片资源... '+onload+'/'+total
                    if(onload == 6) {
                        this.loadingHint = '加载完毕！'
                        clearInterval(this.timer)
                        this.timer = null
                        console.log('进度为100')
